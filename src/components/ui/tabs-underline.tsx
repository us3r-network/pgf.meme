...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("flex items-center justify-start max-w-sm:gap-10 gap-4", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "max-w-sm:h-14 h-10 data-[state=active]:border-b-4 data-[state=active]:border-[#16181d] box-border",
      className
    )}
    {...props}
  />
